import { mixins, VDataIterator, VListTileContent, VListTileTitle, Themeable, Colorable } from '../../../vuetify-import'

export default mixins(
  Themeable, Colorable
  /* @vue/component */
).extend({
  name: 'v-data-iterator-select-list',
  props: {
    selectedItems: {
      type: Array,
      default: () => ([])
  ...
  render () {
    ...
    return this.$createElement('div', {
      ...
      children,
      this.$createElement(VDataIterator, {
        attrs: {
          row: '',
          wrap: ''
        },
        ...
        scopedSlots: {
          item: props => this.$scopedSlots['item'](props)
        },
      }), childrenAppend
    ])
  }
